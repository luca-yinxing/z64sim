...
public class SettingsWindow extends JDialog {
    ...
    private JLabel fontEditorLabel;
    private JSpinner fontEditorSpinner;
    private JSpinner fontCompilerSpinner;
    private JLabel fontCompilerLabel;
    ...
    public SettingsWindow() {
        ...
        fontEditorSpinner.setValue(SettingsController.getFontSizeEditor());
        fontCompilerSpinner.setValue(SettingsController.getFontSizeCompiler());
        ...
        fontEditorSpinner.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent changeEvent) {
                needRestart = (int) fontEditorSpinner.getValue() != SettingsController.getFontSizeEditor();
                warningLabel.setVisible(needRestart);
            }
        });
        fontCompilerSpinner.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent changeEvent) {
                needRestart = (int) fontCompilerSpinner.getValue() != SettingsController.getFontSizeCompiler();
                warningLabel.setVisible(needRestart);
            }
        });
    }
    ...
    private void onOK() {
        ...
        SettingsController.setFontSizeEditor((int) fontEditorSpinner.getValue());
        SettingsController.setFontSizeCompiler((int) fontCompilerSpinner.getValue());
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.add(spacer2, new GridConstraints(7, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL, 1, GridConstraints.SIZEPOLICY_WANT_GROW, new Dimension(-1, 5), null, null, 0, false));
        ...
        fontEditorLabel = new JLabel();
        this.$$$loadLabelText$$$(fontEditorLabel, this.$$$getMessageFromBundle$$$("i18n", "font.editor"));
        panel1.add(fontEditorLabel, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        fontEditorSpinner = new JSpinner();
        panel1.add(fontEditorSpinner, new GridConstraints(5, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        fontCompilerSpinner = new JSpinner();
        panel1.add(fontCompilerSpinner, new GridConstraints(6, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        fontCompilerLabel = new JLabel();
        this.$$$loadLabelText$$$(fontCompilerLabel, this.$$$getMessageFromBundle$$$("i18n", "font.compiler"));
        panel1.add(fontCompilerLabel, new GridConstraints(6, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        languageLabel.setLabelFor(languageComboBox);
        themeLabel.setLabelFor(themeComboBox);
        logLevelLabel.setLabelFor(logLevelComboBox);
        fontEditorLabel.setLabelFor(fontEditorSpinner);
        fontCompilerLabel.setLabelFor(fontCompilerSpinner);
    }
